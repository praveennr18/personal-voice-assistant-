...
def take_screenshot():
    ...
    file_path = f"C:\\Users\\xyz\\Desktop\\abc\\screenshots\\screenshot{count}.jpg"
    screenshot.save(file_path)  # Save the screenshot
...
if __name__ == '__main__':
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak('I am  your personal assistant. I am programmed to perform tasks like '
                  'opening YouTube, Google Chrome, Gmail, and Stack Overflow, predict time, take a photo, search Wikipedia, predict weather ,take screenshot'
            ...
            try:
                speak("Which month and year?")
                statement = takeCommand().lower()
                match = re.search(r'(\d{4}) (\d{1,2})', statement)
                if match:
                ...
                print(e)
                speak("I could not fetch the calendar. Please try again.")
        ...
        elif "mute volume" in statement:
            pyautogui.press("volumemute")
            speak("Volume muted")

        elif "read a file" in statement:
            speak("Which file would you like to read?")
            filename = takeCommand() + ".txt"
        ...
        elif 'question' in statement or 'any question' in statement or 'questions' in statement:
        ...
        elif "calculate" in statement or "evaluate" in statement or "calculation" in statement or "evaluation" in statement:
